...
parser.add_argument('--db', default='pet.db', help='sqlite3 database')
parser.add_argument('--schema', default='petschema.sql', help='schema definition')
parser.add_argument('--data', default='petdata.sql', help='data')
